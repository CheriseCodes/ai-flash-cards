            ...
            <div className="flash-card-content">
              ...
              <div className="image-container">
                {!cardData.generatingImage ? (
                  <img height={250} width={250} src={cardData.img} crossOrigin="anonymous" alt={`Visualization of "${cardData.translatedSampleSentence}"`} onError={(import.meta.env.VITE_APP_ENV?.includes("production")) ? reloadImage : () => {}} onLoad={loadedImage} hidden></img>
                ) : (
                  <LoadingSpinner />
                )}
