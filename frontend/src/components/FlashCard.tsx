            ...
            <div className="flash-card-content">
              ...
              <div className="image-container">
                {!cardData.generatingImage ? (
                  <img height={250} width={250} src={cardData.img} crossOrigin="anonymous" alt={`Visualization of "${cardData.translatedSampleSentence}"`} onError={process.env.NODE_ENV == "dev" ? () => {} : reloadImage} onLoad={loadedImage} hidden></img>
                ) : (
                  <LoadingSpinner />
                )}
